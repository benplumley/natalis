...
\begin{enumerate}
	...
	\item Greetings cards purchases are also driven by high conditional values as they focus on commemorating a specific event. Cards aimed at once in in a life time events hold higher value for the consumer as do cards purchased close to the date they are intended for. 
\end{enumerate}
