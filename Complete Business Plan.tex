...
Therefore, for to gain further and more concise market validation, we have planned to create and launch a prototype website where customers can sign up to our service, and analyse it to discover whether there is in fact a market for our idea. If we were properly launching our business, we would need a partner greetings cards firm to create the cards for us and send them to the customers. However, we want to find out whether people would use our system before investing too much time into it. Therefore we plan to manually buy and send the cards to customers ourselves. So far, we have created some UI designs for the front-end of the web application, which are included in the appendix. We asked two friends to look at the designs and tell us if they were clear and aesthetically pleasing, both of which said they were. Also, we planned out how we will create the back-end and are currently in the process of implementing it. The next step will be to launch the prototype website, and discover whether there is a market for our business. 
